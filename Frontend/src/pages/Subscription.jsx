  ...
  return (
    <DashboardLayout activeMenu="Subscription">
      <div className='p-6'>
        ...
        <p className="text-gray-600 mb-6">Choose a plan that works best for you</p>
        {message && (
          <div className={`mb-6 p-4 rounded-lg flex items-center gap-3 ${messageType === 'error' ? 'bg-red-50 text-red-700' : messageType === 'success' ? 'bg-green-50 text-green-700' :
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {plans.map((plan) => (
            <div
              ...
              {plan.recommended && (
                <div className="inline-block bg-red-500 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">
                  RECOMMENDED
                </div>
              )}
